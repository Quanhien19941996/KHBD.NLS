...
<div class="main-header">
    ...
    <p>Tác giả: Quan Văn Hiện - Trường PTDTBT Tiểu học Hùng Mỹ - ĐT: 0984960025</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Quan Văn Hiện - Trường PTDTBT Tiểu học Hùng Mỹ - ĐT: 0984960025 </div>", unsafe_allow_html=True)
